...
| 6 | Management appliances | Shut down VCF Operations for Networks, VCF Operations for Logs, VCF Operations, VCF Operations Collector, VCF Operations Fleet Management, VCF Automation (if deployed), NSX Manager, SDDC Manager, then vCenter (last) | All management VMs powered off |
